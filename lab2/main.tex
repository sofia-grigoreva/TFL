...
Неопределённость возникает при чтении каждой первой буквы каждой пары букв после $.a$, так как следующая буква может относиться к $(ab)^*$ или к  $.a$ (если это $a$) и к $(bb)^*$ или к  $.a$ (если это $b$). Предпросмотр (отрицание) в начале строки позволяет разграничить эти случаи по второй букве пары.
% -------------------------------------------------------------------------------------
\newpage
